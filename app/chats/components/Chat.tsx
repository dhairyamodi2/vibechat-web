...
export const ChatBox : React.FC<ChatProps> = function( {chat, lastMessage}) {
    ...
    return (
        <div className={`${params && params.chatId ? 'hidden p-0 my-0 sm:flex' : ''} p-3 flex items-center my-3 rounded-xl ${params.chatId === chat.id ? 'bg-gray-200' : ''} hover:bg-gray-200 flex-1 cursor-pointer shadow-lg drop-shadow-md mx-`} ref={lasref} onClick={handleClick}>
